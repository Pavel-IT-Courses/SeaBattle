package com.gmail.pavkascool.update.views;
...
import com.gmail.pavkascool.update.OnFireListener;
import com.gmail.pavkascool.update.R;
...
//
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.colorSea));

        canvas.drawRect(0, 0, cellSize * cols, cellSize * rows, paint);

        if (!shots.isEmpty()) {

            paint.setColor(getResources().getColor(R.color.colorShot));
        ...
        if (!neighbours.isEmpty()) {
            ...
            paint.setColor(getResources().getColor(R.color.colorNeighbour));
        ...
        if (!hits.isEmpty()) {
            ...
            paint.setColor(getResources().getColor(R.color.colorHit));
